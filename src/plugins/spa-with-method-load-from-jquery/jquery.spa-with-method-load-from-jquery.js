        ...
        $.fn.spaWithMethodLoadFromJQuery = function (options) {
            ...
            const loadTodoContentInHtml = route => {
                ...
                $layoutHeader.load(settings.urlHeader, function () {
                    $('#titlePageHeader').html(route.headerTitle);
                });
                ...
                //  -----  cargamos el footer  -----
                $layoutFooter.load(settings.urlFooter, function () {
                    $('#titlePageFooter').html(route.headerTitle);
                });
            ...
            const actionsNavbar = () => {
                ...
                $(document).on('click', '.navbar__btn', function (e) {
                    e.stopPropagation();
